...
public class Main implements Runnable, ActionListener{
  ...
  public void run(){
    ...
    String instructions = "This is a simple triangle detector.\nEnter and integer in each of the text fields above.\nPress the button \"Validate Button\" to find out whether you made a valid triangle or not.\nYou can press reset to clear everything out."; 

    // set the text in the instruction area
    instructionArea.setText(instructions);

    // set the location and size of text area
